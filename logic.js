...
function createFeatures(earthquakeData) {
  ...
  // in the features array 
    // Give each feature a popup describing the magnitude and long/lat of the earthquake
    // i'm guessing on the indexes but it seems right
  function onEachFeature(feature, layer) {
    layer.bindPopup("<h3>" + feature.properties.mag +
      "</h3><hr><p>" + newplace(feature.geometry[0] + feature.geometry[1]        
        ) + "</p>");
  }
...
// from here, all this code is from our earthquake exercise in class. 
